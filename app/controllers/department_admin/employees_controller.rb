module DepartmentAdmin
  class EmployeesController < ApplicationController
    ...
    def index
      ...
      @employees = Employee.where(department: current_employee.department).includes(:department, :driver_license, :vehicle_inspection, :compulsory_insurance, :optional_insurance).search(@search_params).page(params[:page])
    end
